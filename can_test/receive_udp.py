...
if __name__ == '__main__':
    ...
    # while display.IsOpen():
        ...
        if can_this_frame['SystemError']:
            ...
            A3_BL_display()
        elif can_this_frame['MotorOverHeat']:
            A3_MH_display()
        ...
        if can_this_frame['NavigationDirection'] == 'go straight':
            A4_S_display()
        elif can_this_frame['NavigationDirection'] == 'turn left':
            A4_TL_display()
        elif can_this_frame['NavigationDirection'] == 'turn right':
            A4_TR_display()
        ...
        if can_this_frame['FrontCollisionLevel'] == 'level1':
            B3_F_L1_display()
        elif can_this_frame['FrontCollisionLevel'] == 'level2':
            B3_F_L2_display()
